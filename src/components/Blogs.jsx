      ...
      <div className="flex flex-col  md:flex-row gap-8 mt-[50px]">
        ...
        >
          ...
          <div className="px-6 py-7">
            ...
            <p className="text-md">
              Discover the secrets to maintaining excellent oral hygiene. From
              brushing and flossing techniques to the best products for your
              teeth, this guide has everything you need for a brighter,
              healthier smile.
            </p>
          ...
          <div className="  bg-white flex flex-col  md:flex-row  rounded-2xl">
            ...
            <div className="md:w-3/5">
              ...
              <div className="px-6 py-7">
                ...
                <p>
                  Are you falling for common dental myths? Learn the truth about
                  teeth whitening, cavity prevention, and more. Protect your
                  oral health with facts, not fiction.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="  bg-white flex  flex-col md:flex-row  rounded-2xl my-5">
            ...
            <div className="w-full md:w-3/5">
              ...
              <div className="px-6 py-7">
                ...
                <p>
                  Did you know your oral health impacts your overall well-being?
                  Explore how dental care plays a crucial role in preventing
