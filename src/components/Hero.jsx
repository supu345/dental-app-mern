...
const Hero = () => {
  const slides = [
    ...
    },
    {
      ...
      description:
        "Discover how dental health is connected to your body's overall health, including its impact on heart disease, diabetes, and more—and why oral hygiene is essential.",
    },
    {
      id: 7,
