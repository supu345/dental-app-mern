  ...
  return (
    <Layout>
      <div className="mt-[50px]">
        ...
        <h1 className="text-xl pt-3 text-center text-black">
          What Our Clients Say
        </h1>
        <div
          className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 bg-amber-500 gap-6 py-7 px-4 md:px-9 mt-9 w-full"
          style={{
            backgroundImage:
